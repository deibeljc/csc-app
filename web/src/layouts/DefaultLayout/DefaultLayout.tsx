            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
              <div className="relative py-5 flex items-center justify-center lg:justify-between">
                ...
                <div className="absolute left-0 flex-shrink-0 lg:static">
                  ...
                  >
                    <span className="sr-only">Counterstrike Confederation</span>
                    <img
                            ...
                            {({ active }) => (
                              <button
                                ...
                                className={classNames(
                                  active ? 'bg-gray-100' : '',
                                  'block text-left w-full cursor-pointer px-4 py-2 text-sm text-gray-700'
                                )}
                              >
                                {item.name}
                              </button>
                        ...
                        <div className="mt-3 px-2 space-y-1">
                          {userNavigation.map((item) => (
                            <button
                              key={item.name}
                              onClick={item.onClick}
                              className="block w-full text-left cursor-pointer rounded-md px-3 py-2 text-base text-gray-900 font-medium hover:bg-gray-100 hover:text-gray-800"
                            >
                              {item.name}
                            </button>
                          ))}
          ...
          <div className="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              <section aria-labelledby="section-2-title">
                ...
                <div className="rounded-lg bg-white overflow-hidden shadow">
                  <div className="p-6">{location.pathname}</div>
                </div>
              </section>
            </div>
          </div>
      ...
      <footer>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="border-t border-gray-200 py-8 text-sm text-gray-500 text-center sm:text-left">
            <span className="block sm:inline">Counterstrike Confederation</span>
          </div>
        </div>
      </footer>
    </div>
